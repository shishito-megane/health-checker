...
def database():
    ...
    graph_dataset,table_dataset,m = datas(hourly_data,point_data,height)

    # 判定
    lev,lev_img,lev_msg = judge(sex,table_dataset["sum_hosu"])
...
def database():
    ...
    # データの成形
    span = get_daily_span(hourly_data)
    graph_dataset,t,map_dataset = datas(hourly_data,point_data,height)
...
#    """Internal Server Errorの場合"""
    ...
    #return データ表示期間内に、サーバに問題があったか、データ表示期間に間違いがある可能性があります。
